...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const finishSplash = () => {
      document.documentElement.classList.add("hero-ready"); setSplashLeaving(true); window.setTimeout(() => setSplashGone(true), 620); };
    ...
    const revealObserver = setupReveals();
  ...
  return (
    <>
      {!splashGone && <div className={splashLeaving ? "splash is-leaving" : "splash"}><div className="splash-name">
            <span className="splash-line splash-line-1">IZAK</span>
            <span className="splash-line splash-line-2">HYLLESTED</span>
          </div></div>}
      ...
      <main className="main">
        <section className="hero">
          <div data-reveal className="hero-meta hero-sequence hero-sequence-1"><span className="blend-text">00 / MMXXVI</span><span className="blend-text">Copenhagen</span></div>
          <div className="hero-title-wrap"><h1 data-reveal className="hero-title hero-sequence hero-sequence-2 blend-text">Graphic<br />Designer &<br />Creative<br />Developer</h1></div>
          <div data-reveal className="hero-grid hero-sequence hero-sequence-3">

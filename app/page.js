  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      if (graphicRef.current) {
        graphicRef.current.style.transform = `translate3d(-50%, ${currentGraphicY.toFixed(2)}px, 0)`;
      }
    ...
    <>
      ...
      <div className="blend-stage">
        <div className="stage-graphic" aria-hidden="true">
          <img ref={graphicRef} src="/hero-graphic.png" alt="" className="stage-graphic-image" />
        </div>

        <div className="stage-images" aria-hidden="true">
          <img ref={portraitRef} src="/profile.jpg" className="portrait" alt="" />
        </div>
        ...
        <main className="main site">
          <section className="hero">
            ...
            <div className="hero-title-wrap">
              <h1 className="hero-title blend-layer">
                Graphic
                <br />
                Designer &
                <br />
            ...
            <div className="hero-grid blend-layer">
              <div>
          ...
          <section className="portrait-section">
            ...
            <div className="portrait-caption blend-layer">
          ...
          <section className="projects-section">
            <div className="section-top blend-layer">
          ...
          <section className="about-strip" id="about">
            ...
            <a href="mailto:izakhyllested@icloud.com" className="blend-layer">
              Start a project →
            </a>
          </section>
        </main>

  ...
  return (
    <>
      ...
      <div className="app-layers">
        ...
        <main className="main l2-text-layer">
          <section className="hero">
            ...
            <div className="hero-title-wrap">
              <h1 className="hero-title content-blend">
                Graphic
                <br />
                Designer &
                <br />
            ...
            <div className="hero-grid content-blend">
              <div>
          ...
          <section className="portrait-section">
            ...
            <div className="portrait-caption content-blend">
          ...
          <section className="projects-section">
            <div className="section-top content-blend">
          ...
          <section className="about-strip content-blend" id="about">
            <p>
